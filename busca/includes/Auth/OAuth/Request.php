...
class Request {
	...
	public static function from_request($http_method=NULL, $http_url=NULL, $parameters=NULL) {
		...
		if (!$parameters) {
			...
			// We have a Authorization-header with Utildata. Parse the header
			// and add those overriding any duplicates from GET or POST
			if (isset($request_headers['Authorization']) && substr($request_headers['Authorization'], 0, 6) == 'Util') {
	...
	public function to_header($realm=null) {
		$first = true;
	if($realm) {
			$out = 'Authorization: Utilrealm="' . Util::urlencode_rfc3986($realm) . '"';
			$first = false;
		} else
